        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">관심있는 동네를 구독하세요</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-3">
              ...
              <p className="text-sm text-muted-foreground">새로운 축제 소식을 받아보세요</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-3">
              ...
              <p className="text-sm text-muted-foreground">놓치지 말고 축제를 즐기세요</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">픽동이 제공하는 서비스</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              구독한 지역에서 열리는 다양한 축제와 행사 정보를 한눈에 확인하고, 놓치지 않도록 메일을 받아보세요.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                서울 광진구, 용산구 등 관심있는 지역을 선택하면, 해당 지역에서 열리는 모든 축제와 행사 정보를 받아볼 수
                있습니다.
              </p>
            ...
            <div className="bg-gradient-to-br from-primary/10 to-accent/10 rounded-2xl p-8 text-center">
              ...
              <p className="text-sm text-muted-foreground">대한민국 전체 지원</p>
            </div>
          </div>
        </div>
      </section>
